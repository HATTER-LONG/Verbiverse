...
from CustomWidgets import (CTabWidget, CTestLabel)
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.video_widget = VideoWidget(self.layoutWidget)
        ...
        self.subtitle_widget = QWidget(self.layoutWidget)
        ...
        self.subtitel_browser = CTestLabel(self.subtitle_widget)
        ...
        self.parse_button = QToolButton(self.subtitle_widget)
