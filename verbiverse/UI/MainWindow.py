...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(47, 0, 677, 392))
        ...
        self.user_text_edit.setMinimumSize(QSize(600, 100))
        self.user_text_edit.setMaximumSize(QSize(16777215, 500))
        ...
        sizePolicy1.setHeightForWidth(self.user_check_button.sizePolicy().hasHeightForWidth())
        self.user_check_button.setSizePolicy(sizePolicy1)
